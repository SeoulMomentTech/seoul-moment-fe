      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            <Label className={FIELD_LABEL_CLASS} htmlFor="custom-info-height">
              키
            </Label>
            <Input
              id="custom-info-height"
              inputMode="numeric"
              onChange={(e) =>
          ...
          <div className="flex flex-col gap-2">
            <Label className={FIELD_LABEL_CLASS} htmlFor="custom-info-weight">
              몸무게
            </Label>
            <Input
              id="custom-info-weight"
              inputMode="numeric"
              onChange={(e) =>
