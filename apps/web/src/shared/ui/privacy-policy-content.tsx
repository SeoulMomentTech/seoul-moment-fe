...
export function PrivacyPolicyContent(): ReactNode {
  return (
    <LegalDocument title="首爾映像有限公司 隱私權政策">
        ...
        <SubSection title="蒐集之個人資料類別">
          ...
          <Bullets
            items={[
              ...
              "線上客服與聊天機器人對話紀錄：您使用本平台線上客服或聊天機器人（AI客服）服務時所輸入之對話內容、諮詢問題及互動紀錄，將儲存於本公司伺服器",
              "其他資料：您主動提供之其他資料",
            ]}
          />
        </SubSection>
        ...
        <SubSection title="您主動提供">
          <Bullets
            items={[
              ...
              "線上客服與聊天機器人對話：您使用本平台線上客服或聊天機器人（AI客服）功能時所輸入之對話內容及諮詢紀錄，將儲存於本公司伺服器，供提供客服服務、回覆諮詢、品質改善及紀錄查詢之用",
              "第三方登入服務：您使用 LINE Login 等第三方登入服務註冊或登入本平台時，本公司可能依您授權之範圍取得您的電子郵件信箱及基本帳號資訊，並用於會員身分驗證、帳號管理、客戶服務及相關通知用途",
            ]}
          />
        </SubSection>
        ...
        <SubSection title="行使方式">
          ...
          <Bullets
            items={[
              ...
              "電子郵件：寄送申請至 seoulmomenttw@gmail.com，主旨請註明「行使個人資料當事人權利」，並檢附身分證明文件掃描檔",
              "客服電話：撥打客服專線 0917-986-827，服務時間 週一至週五 09:00－21:00｜週末（週六）12:00－16:00，客服人員將協助您進行申請",
            ]}
          />
        </SubSection>
        ...
        <SubSection title="聯絡資訊">
          <Bullets
            items={[
              "首爾映像有限公司",
              "個人資料保護聯絡窗口",
              "電子郵件：seoulmomenttw@gmail.com",
              "客服電話：0917-986-827",
              "服務時間：週一至週五 09:00－21:00｜週末（週六）12:00－16:00",
      ...
      <Paragraph>最後更新日期：2026年8月5日</Paragraph>
    </LegalDocument>
  );
}
