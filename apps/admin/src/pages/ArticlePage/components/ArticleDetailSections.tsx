...
type ArticleSection = CreateAdminArticleRequest["sectionList"][number];
          ...
          {sections.map((section, sectionIndex) => (
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                <Label htmlFor={`article-section-image-${sectionIndex}`}>
                  이미지
                </Label>
                <MultipleImageUpload
                  folder="article"
                    ...
                    >
                      <VStack gap={8}>
                        <div className="w-full space-y-2">
                          <Label
                            htmlFor={`article-section-title-${sectionIndex}-${language.id}`}
                          >
                            제목
                          </Label>
                          <Input
                            ...
                            id={`article-section-title-${sectionIndex}-${language.id}`}
                            onChange={(e) =>
                              onChangeText(
                                sectionIndex,
                                language.id,
                        ...
                        <div className="w-full space-y-2">
                          <Label
                            htmlFor={`article-section-subtitle-${sectionIndex}-${language.id}`}
                          >
                            부제목
                          </Label>
                          <Input
                            id={`article-section-subtitle-${sectionIndex}-${language.id}`}
                            onChange={(e) =>
                              onChangeText(
                                sectionIndex,
                                language.id,
                        ...
                        <div className="w-full space-y-2">
                          <Label
                            htmlFor={`article-section-content-${sectionIndex}-${language.id}`}
                          >
                            내용
                          </Label>
                          <Textarea
                            ...
                            id={`article-section-content-${sectionIndex}-${language.id}`}
                            onChange={(e) =>
                              onChangeText(
                                sectionIndex,
                                language.id,
