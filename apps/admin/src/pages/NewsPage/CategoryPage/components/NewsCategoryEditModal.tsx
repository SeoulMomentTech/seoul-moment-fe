...
interface NewsCategoryEditModalProps {
  isOpen: boolean;
...
export function NewsCategoryEditModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
  defaultValues,
}: NewsCategoryEditModalProps) {
  const {
    register,
    handleSubmit,
    reset,
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
        ...
        <p className="mb-4 text-sm text-gray-500">
          선택한 뉴스 카테고리의 이름을 수정합니다.
        </p>
        <div className="mb-6 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="editNewsCategoryNameKo">카테고리 이름(한국어)</Label>
            <Input
              className="h-[40px] rounded-md bg-white"
              id="editNewsCategoryNameKo"
          ...
          <div className="space-y-2">
            <Label htmlFor="editNewsCategoryNameEn">카테고리 이름(영어)</Label>
            <Input
              className="h-[40px] rounded-md bg-white"
              id="editNewsCategoryNameEn"
          ...
          <div className="space-y-2">
            <Label htmlFor="editNewsCategoryNameZh">카테고리 이름(중국어)</Label>
            <Input
              className="h-[40px] rounded-md bg-white"
              id="editNewsCategoryNameZh"
              placeholder="예: 品牌新聞"
